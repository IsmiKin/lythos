 ...
 * @author Rocio
 */
@WebServlet(name = "formUsuario", urlPatterns = {"/formUsuario"})
public class formUsuario extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       RequestDispatcher rd=null; 
        ...
        rd = this.getServletContext().getRequestDispatcher("/insertarUsuario.jsp");        
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet formUsuario</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet formUsuario at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        } finally {            
            out.close();
