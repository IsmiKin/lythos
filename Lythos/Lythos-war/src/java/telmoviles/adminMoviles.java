 ...
 * @author Rocio
 */
@WebServlet(name = "adminTelMovil", urlPatterns = {"/adminTelMovil"})
public class adminMoviles extends HttpServlet {
    @EJB
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Terminalmovil> todos =  terminalmovilFacade.findAll();
        
        request.setAttribute("todosTerminalesM", todos);
        ...
        rd = this.getServletContext().getRequestDispatcher("/admintelmoviles.jsp");        
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title> Admin Terminales Moviles</title>");            
            out.println("</head>");
            out.println("<body>");
